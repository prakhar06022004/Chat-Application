...
function SignUp() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center p-0 sm:p-2">
      <div className="w-full max-w-[500px] sm:h-[600px] h-full border-2 sm:border-[#20c7ff] border-none shadow-xl shadow-gray-300 rounded-[10px] flex flex-col overflow-hidden select-none">
